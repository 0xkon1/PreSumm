...
### CNN/DM
```
 python train.py -task ext -mode validate -batch_size 3000 -test_batch_size 500 -log_file ../logs/val_abs_bert_cnndm -model_path ./MODEL_PATH -sep_optim true -use_interval true -max_pos 512 -max_length 200 -alpha 0.95 -min_length 50 -result_path ../logs/abs_bert_cnndm
```
### XSum
```
